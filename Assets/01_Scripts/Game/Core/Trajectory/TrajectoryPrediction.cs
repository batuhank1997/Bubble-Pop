...
namespace _01_Scripts.Game.Core.Trajectory
{
    public class TrajectoryPrediction : MonoBehaviour
    {
        ...
        public (Vector2, Vector2) Predict(Vector2 origin, Vector2 dir)
        {
            ...
            if (hit.collider != null)
            {
                ...
                return (hit.point, targetCell.transform.position);
            }
        
            lineRenderer2.enabled = false;
        
            return (lineRenderer1.GetPosition(0), lineRenderer1.GetPosition(1));
        }
